...
SOCIAL_ENGINEERING_DATASET = [
    ...
    {"text": "Hurry! There's a pending transaction on your account. Confirm or deny it within the next 5 minutes to avoid charges", "label": "social_engineering", "category": "urgency", "confidence": 0.88},
